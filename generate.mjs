...
(0, child_process_1.execSync)("mkdir day" + day, {
    shell: "powershell.exe"
});
(0, child_process_1.execSync)("new-item index.ts", {
    cwd: "day" + day,
    shell: "powershell.exe"
});
var input = await fetch("https://adventofcode.com/2022/day/21/input", {
...
(0, child_process_1.execSync)("echo '" + input + "' | new-item input.txt", {
    cwd: "day" + day,
    shell: "powershell.exe"
});
